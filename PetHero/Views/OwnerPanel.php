        ...
        <div class="row">
            ...
            <div class="col-sm-auto bg-light sticky-top">
                <div class="d-flex flex-sm-column flex-row flex-nowrap bg-light align-items-center sticky-top">
                    ...
                    <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center" role="tablist" id="pills-tab" aria-orientation="vertical">
                        <li class="nav-item">
                            <a href="#" class="nav-link active py-3 px-2" type="button" role="tab" id="ownerData-tab" data-bs-toggle="pill" data-bs-target="#ownerData" aria-controls="ownerData" aria-selected="true" data-bs-placement="right">
                                <i class="bi bi-journal-text fs-1"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link py-3 px-2" type="button" role="tab" id="petList-tab" data-bs-toggle="pill" data-bs-target="#petList" aria-controls="petList" aria-selected="false" data-bs-placement="right">
                                <i class="bi bi-twitter fs-1"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link py-3 px-2" type="button" role="tab" id="bookings-tab" data-bs-toggle="pill" data-bs-target="#bookings" aria-controls="bookings" aria-selected="false" data-bs-placement="right">
                            ...
                            <tbody>
                                <?php foreach ($bookList as $book) { ?>
                                    <tr>
                                                ...
                                                <div class="col-2">
                                                    <?php foreach ($imgList as $img) { ?>
                                                        <?php if ($img->getPublication()->getId() == $book->getPublication()->getId()) { ?>
                                                            <img src="<?php echo $img->getUrl() ?>" class="rounded-circle" alt="" style="width: 45px; height: 45px" />
                                                        <?php } ?>
                                                    <?php } ?>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="row">
                                                <?php foreach ($bPetsList as $pet) { ?>
                                                    <?php if ($pet->getBooking()->getId() == $book->getid()) { ?>
                                                        <div class="col-2">
                                                            <img src="<?php echo $pet->getPet()->getProfileIMG() ?>" class="rounded-circle" alt="" style="width: 45px; height: 45px;" />
                                                        </div>
                                                    <?php } ?>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <td>
                                            <?php if ((STRCMP($book->getBookState(), "Awaiting Payment") == 0)) { ?>                                                    <form action="<?php echo FRONT_ROOT . "/Booking/EnterPaycode" ?>" method="post" name="sendPayC">
                                                        <div class="form-floating mb-3">
                                                            <input type="hidden" name="idBook" value=<?php echo $book->getId() ?>>
                                                            <input type="number" class="form-control" id="payCode" placeholder="San Antonio" name="payCode" onkeypress="if (event.keyCode == 13) send()" required>
                                        ...
                                        <td>
                                            ...
                                            <?php }
                                            if ((STRCMP($book->getBookState(), "Canceled") == 0) xor
                                                (STRCMP($book->getBookState(), "Expired") == 0) xor
                                                (STRCMP($book->getBookState(), "Declined") == 0) xor
                                                (STRCMP($book->getBookState(), "Out of Term ") == 0) xor
                                                (STRCMP($book->getBookState(), "Out of Term") == 0) xor
