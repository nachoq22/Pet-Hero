        ...
        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="<?php echo FRONT_ROOT ?>/Views/Img/carousel/salchi.png" class="d-block w-100" style="width: 100%; height: 30vw; object-fit: cover;" alt="Salchi">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="<?php echo FRONT_ROOT ?>/Views/Img/carousel/perro-correa.png" class="d-block w-100" style="width: 100%; height: 30vw; object-fit: cover;" alt="Perro con correa">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="https://images.ctfassets.net/gxwgulxyxxy1/4gwMDV1dxGvZRwguxSUBfS/4868ea3358b99376cde22e23debba570/southeast-petfriendly-beach-holidays.jpg" class="d-block w-100" style="width: 100%; height: 30vw; object-fit: cover;" alt="Playa pet-friendly">
                </div>
            ...
            <?php foreach ($publicList as $public) { ?>
                <div class="col">
                    <div class="card text-bg-dark">
                        ...
                        <div class="card-img-overlay" style="background-color: rgba(0,0,0,0.4); text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7);">
